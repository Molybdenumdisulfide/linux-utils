...
| `config/packages.json` | Declarative package manifest — edit to define desired packages |
| `tools/install-packages.sh` | Post-install package installer — reads `packages.json` and installs packages |
